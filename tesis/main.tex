...
En la tabla \ref{tab:summary NN salidas problemas tsne} se contemplan las caracteristicas de las capas de salida para cada modelo propuesto.% es de resaltar que no se desarrolló una red neuronal que pueda traducir los datos pos t-SNE
...
\begin{table}[ht]
	...
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Caracteristicas de las capas de salida para cada red propuesta según el tipo de clasificación}
