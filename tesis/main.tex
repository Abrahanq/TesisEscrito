...
\label{subsec:vector características}
...
Se introducen como datos de entrada para el análisis de componentes principales, los vectores de características mencionados en la subsección \ref{subsec:vector caracteristicas} los cuales serán sujetos de la reducción de dimensionalidad.
