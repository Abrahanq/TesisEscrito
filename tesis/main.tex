...
La matriz de confusión para la clasificación binaria del estado de salud (véase fig. \ref{fig:mtxsalud}), muestra un desempeño notable del modelo, con una exactitud general elevada, esto se evidencia por los valores diagonales dominantes. Del total de casos patológicos, $2840$ fueron correctamente identificados, mientras que solo 116 fueron incorrectamente clasificados como sanos, lo que representa una sensibilidad superior al $96\%$. Por otro lado, de los casos sanos, $3255$ fueron correctamente identificados y unicamente 165 fueron clasificados erróneamente como patológicos, alcanzando una especifidad cercana al $95\%$. Este patrón indica que el modelo basado en componentes principales logra discriminar efectivamente entre ambas categorías, con un bajo numero de falsos positivos y de falsos negativos, lo cual puede resultar relevante desde el punto de vista clínico, donde minimizar falsos negativos resulta crítico para evitar pasar por alto patologías en pacientes que las presentan.
...
La matriz de confusión multiclase para la clasificación de trastornos clínicos (mencionados en la tabla \ref{tab:tipos_trastornos}) revela un desempeño diferenciado según la categoría (véase fig. \ref{fig:mtxtrastornos}). La clase \guillemetleft Sanos\guillemetright \ presenta la mayor capacidad discriminatoria, con 3314 identificaciones correctas y muy pocos errores de clasificación hacia otras categorías, alcanzando una precisión superior al $98\%$. La categoría \guillemetleft Sueño\guillemetright, que corresponde a los pacientes con trastornos de la respiración durante el sueño, también muestra un rendimiento robusto con 1162 aciertos, aunque esta presenta una mayor confusión con la clase \guillemetleft Sanos\guillemetright \ (83 casos). Por su parte, la clase \guillemetleft Ritmo\guillemetright, correspondiente a los pacientes con trastornos del ritmo cardíaco, obtiene 1059 clasificaciones correctas pero exhibe una confusión moderada con la clase \guillemetleft Sueño\guillemetright (31 casos) y \guillemetleft Sanos\guillemetright (37 casos). La categoría \guillemetleft Insuficiencia\guillemetright, correspondiente a los pacientes con trastornos de la función de bomba del corazón, presenta 550 aciertos y muestra una confusión relativamente alta (en comparación a casos anteriores), con la clase \guillemetleft Ritmo \guillemetright \ (20 casos), Este patrón sugiere que, si bien el modelo logra separar adecuadamente los casos sanos y ciertos trastornos específicos, la diferenciación entre estos subtipos de patologías puede presentar desafíos adicionales, posiblemente debido a solapamientos en los perfiles electrocardiográficos de las distintas condiciones que se presentan.
...
La matriz de confusión para la clasificación por grupos etarios (véase fig. \ref{fig:mtxetarios}), muestra un desempeño desigual entre las tres categorías. El grupo de \guillemetleft Mayores\guillemetright \ presenta la mejor capacidad de identificación con $1404$ clasificaciones correctas y relativamente pocos errores (139 confusiones con jóvenes y 187 con mediana edad), alcanzando una exactitud aproximada del $81\%$. El grupo de \guillemetleft Mediana edad\guillemetright \ también muestra un rendimiento aceptable con $1871$ aciertos, aunque presenta mayor confusión con los otros grupos (331 casos con jóvenes y 88 con mayores), lo que representa una precisión cercana al $82\%$. Sin embargo, el grupo de \guillemetleft Jóvenes\guillemetright exhibe la mayor dificultad discriminativa, con 1985 identificaciones correctas pero con confusiones significativas hacia el grupo de mediana edad (258 casos) y mayores (113 casos), resultando en un precisión aproximada del $81\%$. Estos resultados sugieren que los patrones electrocardiográficos asociados a la edad presentan una transición gradual y continua en lugar de limites discretos claramente definidos, especialmente en las fronteras entre grupos contiguos, lo cual dificulta la clasificación categórica estricta y refuerza la naturaleza evolutiva de las características cardíacas a lo largo del ciclo vital.


\begin{figure}[h]
	\centering
	\includegraphics[width=0.80\linewidth]{Sem_1/figuras/Matriz_etarios.png}
