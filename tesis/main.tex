...
En la ecuacion \ref{eq:einstein} dice que la masa por la velocidad de la luz al cuadrado es igual a la energia
 % Llego hasta aquí porque voy a comenzar a meterle a los datos, siento que ya no puedo avanzar si no tengo los datos listo, necesito tener eso para que el marco metodologico quede claro
