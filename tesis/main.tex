...
\begin{figure}[h]
	...
	\caption{Histograma de los porcentajes de las }
...
\section{Análisis exploratorio tsne}

La figura \ref{fig:pc1vspc2} parece sugerir que si bien PC1 y PC2 capturan cierta variabilidad discriminatoria entre estados de salud, la separación lineal en este subespacio bidimensional resulta insuficiente para una clasificación robusta, esto justifica el uso de técnicas como t-SNE o modelos no lineales que aprovechen componentes adicionales y relaciones más complejas en el espacio de características. 
