...
La figura \ref{fig:pc1vspc2} parece sugerir que si bien PC1 y PC2 capturan parte de la variabilidad relevante para discriminar entre estados de salud, la separación lineal en este subespacio bidimensional demuestra ser insuficiente de las señales electrocardiográficas. Esta limitación justifica el empleo de técnicas de reducción no lineal de la dimensionalidad como t-SNE, que permiten explorar la estructura intrínseca y relaciones complejas presentes en el espacio de características, más allá del alcance de métodos lineales. En esta sección, se presentan visualizaciones bidimensionales del agrupamiento obtenido mediante t-SNE donde se evidencia la formación de cúmulos que representan subpoblaciones diferenciadas.  
