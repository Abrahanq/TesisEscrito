...
%Aca deberia comentar que a pesar que tensorflow ayuda a el dise;o de la red, detras sigue sucediendo lo mismo, dise;ar la red seteando el numero de capaz y perceptrones por capa, ajustar aleatoriamente los primeros pesos y bias de cada capa, para luego calcular la SSE de cada salida, comparandola con la entrada, usando la SSE se calcula el gradiente descendiente en retropropagacion para cada capa y asi poder modificar los pesos y sesgos en la direccion del gradiente minimo y la taza de aprendizaje, se reasignan tanto los pesos como los sesgos y estos ultimos pasos se repiten hasta obtener el error de entrenamiento minimo, 
