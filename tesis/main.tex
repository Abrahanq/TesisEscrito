...
\begin{table}
	...
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Distribución de sujetos sanos según la edad y sexo.}
...
\begin{table}
	...
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Distribución de sujetos patológicos según la edad y sexo.}
...
Aca seria bueno decir que transformar la data en representaciones más apropiadas, puede facilitar el proceso de aprendizaje. for instance, usar un numero menor de parametros, a los cuales se les llama usualmente como caracteristicas, para representar las señales bajo estudio es particularmente importante para propositos de reconocimiento y diagnostico. Dado cualquier conjunto de caracteristicas para  representación de datos, es importante estimar la dificultad de aprender los conceptos subyacentes utilizando esos datos de entrenamiento
Los estudios en la literatura muestran que el grado de dificultad en el entrenamiento de las redes neuronales es inherente al conjunto de ejemplos de entrenamiento dados. Para desarrollar una técnica para medir la dificultad del entrenamiento. % esto esta en la pag del articulo de ceylan
El sistema de entrenamiento deberia entonces tratar de transformar las representaciones a un espacio donde sea más fácil para el aprendizaje 
\textbf{insertar cita del articulo de guler y ubeyli, llamado ECG beat classifier designed
	by combined neural network model}
acomodar esto para poner en orden el orden de ideas 
