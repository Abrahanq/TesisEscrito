...
\begin{table}[ht]
	...
	\begin{center}
		\begin{tabular}{| M{3cm} | M{2cm} | M{0.8cm} | M{0.8cm} | M{0.8cm} | M{2cm} | M{2.2cm} |}
			\hline
			\textbf{Grupo etario (años)} & \textbf{Cantidad} & \textbf{\%} & \textbf{M} & \textbf{F} & \textbf{Edad promedio} & \textbf{Desviación estándar} \\ \hline 
...
\begin{table}[ht]
	...
	\begin{center}
		\begin{tabular}{| M{3cm} | M{2cm} | M{0.9cm} | M{0.8cm} | M{0.8cm} | M{2cm} | M{2.2cm} |}
			\hline
			\textbf{Grupos etario (años)} & \textbf{Cantidad} & \textbf{\%} & \textbf{M} & \textbf{F} & \textbf{Edad promedio} & \textbf{Desviación estándar} \\ \hline 
...
\begin{table}[ht]
	...
	\begin{center}
		\begin{tabular}{| M{2.7cm} | M{1.75cm} | M{0.65cm} | M{0.75cm} | M{0.7cm} | M{1.1cm} | M{2.2cm} | M{1.8cm} | M{2.1cm} |}
			\hline
			\textbf{Grupos etario (años)} & \textbf{Cantidad} & \textbf{\%} & \textbf{M} & \textbf{F} & \textbf{Sanos} & \textbf{Patológicos} & \textbf{Edad promedio} & \textbf{Desviación estándar} \\ \hline 
...
Estos resultados demuestran que el modelo es capaz de capturar diferencias electrocardiográficas inherentes al sexo biológico de los pacientes, lo cual tiene relevancia clínica considerable. Las diferencias en las características del ECG entre hombres y mujeres están bien documentadas en la literatura medica. La alta precisión alcanzada valida que las componentes principales extraídas capturan efectivamente estas diferencias sutiles pero consistentes, lo que sugiere que el modelo podría emplearse para la clasificación por sexo. Además, este hallazgo resalta la importancia de considerar el sexo como variable relevante en el análisis de señales electrocardiográficas, dado que ignorar estas diferencias podría introducir sesgos en los sistemas de clasificación automática y afectar la precisión diagnostica en poblaciones mixtas.
...
Se enfatiza que la interpretación y uso de los modelos automáticos debe estar siempre supervisada por expertos clínicos, reconociendo que las decisiones medicas requieren una evaluación integral que los algoritmos no pueden sustituir, sino complementar de manera responsable.
