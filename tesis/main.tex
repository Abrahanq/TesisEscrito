...
\label{subsec:vector caracteristicas}
...
\begin{table}[ht]
	\renewcommand{\arraystretch}{1.2}
	\begin{center}
		\begin{tabular}{|  M{2.4cm} | M{1.8cm} | M{2.5cm} | M{2cm} | M{1.8cm} |}
			\hline 
			\textbf{Tasa de aprendizaje} & \textbf{Épocas} & \textbf{Optimizador} & \textbf{Función de perdida} & \textbf{Precisión (\%)} \\ \hline
			0.0011 & 200 & Adam & Error cuadrático medio & 75.3\% \\ \hline
		\end{tabular}
	\end{center}
	\caption{}
	\label{}
